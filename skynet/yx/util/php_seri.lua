...
local function _serialize_key(data)  
  --[[  
...
local function _read_until(data, offset, stopchar)  
  --[[  
...
local function _read_chars(data, offset, length)  
  --[[  
...
local function unserialize(data, offset)  
  offset = offset or 0  
  --[[  
...
local function _unknown_type(type_)  
...
function M.unserialize(data, offset)
  return unserialize(data, offset)
end
