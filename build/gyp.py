...
src_root = os.path.normpath(script_dir + "/../")
linux_output_dir = os.path.join(os.path.abspath(src_root), 'build_linux')
...
if __name__ == '__main__':
  ...
  if sys.platform != 'win32':
    ...
    if 'eclipse' not in args and 'ninja' not in args:
      args.extend(['-Goutput_dir=' + linux_output_dir])
      args.extend(['--generator-output', linux_output_dir])
